...
// 07/19/2024   Mitch Lynch     S000369     Changed size of the modal opened by openLogChangeFlow() from small to medium to accommodate the new LWC in the flow. Removed the Add Metadata button and commented out the openAddMetadataFlow() method. Removed label.ChangeEmptyText3.
// 06/29/2024   Mitch Lynch     S000366     Migrated from custom SLDS table to lightning-datatable component.
// 06/21/2024   Mitch Lynch     S000368     Replaced SLDS empty state image with custom image (ImhotepIllustrationEmptyState02).
// 06/18/2024   Mitch Lynch     S000366     Created base component.
// *******************************************************************************************
// NOTES
...
export default class ImhotepStoryChanges extends LightningElement {
    ...
    @wire(getStoryChanges, {paramStoryId: '$recordId'})
        wiredChanges(value) {
